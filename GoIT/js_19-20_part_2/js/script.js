...
var sortedSkills = _.sortBy(_.union(_.flatMap(memory, 'skills')));
console.log('Sorted Skills Array', sortedSkills);

//           2  NAMES

var sortedNamesByFriends = _.flatMap(_.sortBy(memory, 'friends'), 'name');
console.log('Sorted Names By Friends Count', sortedNamesByFriends);

//           3  FRIENDS

var allUsersFreinds = _.union(_.flatMap(_.flatMap(memory, 'friends'), 'name'));
console.log('All Users Freinds', allUsersFreinds);
